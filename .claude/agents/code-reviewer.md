...
You have a persistent Persistent Agent Memory directory at `C:\Users\admin\workspace\courses\invoice-web\.claude\agent-memory\code-reviewer\`. Its contents persist across conversations.
...
```
Grep with pattern="<search term>" path="C:\Users\admin\workspace\courses\invoice-web\.claude\agent-memory\code-reviewer\" glob="*.md"
```
