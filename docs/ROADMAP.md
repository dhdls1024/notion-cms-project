...
- **Task-002: Notion SDK 설치 및 환경 설정** ✅ — 완료
...
- **Task-003: Notion API 레이어 구현 (F001)** ✅ — 완료
  - ✅ `lib/notion.ts` 신규 생성
...
- **Task-004: LinkCard 서버 컴포넌트 구현 (F002)** ✅ — 완료
...
- **Task-005: CopyButton 클라이언트 컴포넌트 구현 (F004)** ✅ — 완료
...
- **Task-006: LinkHubClient 카테고리 필터 컴포넌트 구현 (F005)** ✅ — 완료
...
- **Task-007: app/page.tsx Notion 데이터 연동 (F001 + F003)** ✅ — 완료
...
| 파일 | 상태 | 역할 |
|------|------|------|
| `package.json` | ✅ 완료 | @notionhq/client 추가 |
| `.env.local` | ✅ 완료 | 실제 Notion API 키 입력 |
| `next.config.ts` | ✅ 완료 | Notion 이미지 도메인 추가 |
| `types/index.ts` | ✅ 완료 | LinkItem 타입 정의 |
| `lib/notion.ts` | ✅ 완료 | Notion API 레이어 |
| `components/LinkCard.tsx` | ✅ 완료 | 링크 카드 서버 컴포넌트 |
| `components/CopyButton.tsx` | ✅ 완료 | URL 복사 클라이언트 컴포넌트 |
| `components/LinkHubClient.tsx` | ✅ 완료 | 카테고리 필터 클라이언트 컴포넌트 |
| `app/page.tsx` | ✅ 완료 | Notion 연동 홈페이지 |
| `app/loading.tsx` | ✅ 완료 | Skeleton 로딩 UI |
